...
extension Visit {
    ...
    static func mock(withDate date: Date) -> Visit {
        let Location = ["Walk", "EEE Class", "IEEE Meeting", "Bon_Voyage Hacks", "Birthday !", "Exercise", "Music", "Animal Pictures", "Cooking", "Yoga"]
        let randomInt = Int.random(in: 1..<10)
        return Visit(locationName: Location[randomInt],
